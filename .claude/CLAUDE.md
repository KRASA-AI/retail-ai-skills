...
You are working inside the **Retail & E-commerce AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for retailers. It contains:
...
- Industry page: https://krasa.ai/industries/retail
