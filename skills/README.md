# Skills Library — Retail & E-commerce

This directory contains all AI skills for retail & e-commerce businesses. Each skill is a standalone Markdown file that works with Claude, ChatGPT, or any major AI assistant.
