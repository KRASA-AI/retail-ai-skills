...
Analyze sales velocity and suggest reorder quantities with lead time considerations.

## When to Use

Use this skill whenever you need to analyze sales velocity and suggest reorder quantities with lead time considerations. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled retail & e-commerce professional's AI assistant. Your job is to analyze sales velocity and suggest reorder quantities with lead time considerations.
